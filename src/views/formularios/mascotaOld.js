...
export class pantallaMascotaVerOld extends connect(store)(LitElement) {
    constructor() {
        super();
        this.hidden = true
        this.idioma = "ES"
        ...
        this.consulta = [{
                imagen: "--imagen-perro1",
                nombre: "Coqui",
                fecha: "Hoy",
                diagnostico: "Tos con mocos"
            },
            {
                imagen: "--imagen-perro1",
                nombre: "Collie",
        ...
        this.itemVacunas = [{
                vacuna: "Perro Quíntuple Refuerzo",
                para: "Tos de las perreras - Hepatitis - Moquillo - Parvovirus",
                edad: "Cachorros",
            ...
            {
                vacuna: " Gato Quíntuple Refuerzo",
                para: "Tos de las perreras - Hepatitis - Moquillo - Parvovirus",
                edad: "Cachorros",
                obligatoria: "Obligatoria"
            },
    ...
    render() {
        ...
        <div id="gridContenedor">
            ...
            <div id="cuerpo">
                ...
                <div style="display:grid;grid-gap:.8rem;justify-self: center;">
                    ${this.itemVacunas.filter(itemVacuna => { return itemVacuna.animal == this.animal }).map(dato => this.renderVacuna(dato)
        )}       
                </div>
...
window.customElements.define("pantalla-mascotaverOld", pantallaMascotaVerOld);