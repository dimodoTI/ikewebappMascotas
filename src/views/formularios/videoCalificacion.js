    ...
    render() {
        return html`
            ...
            <div id="btnGuardar" style="width:90%;">
                <button style="width:100%;" btn1>${idiomas[this.idioma].videocalificacion.btn1}</button>
            </div>
            <div id="btnAhoraNo">
                <button btn2>${idiomas[this.idioma].videocalificacion.btn2}</button>
            </div>
        `
    }
    califica(punto){
        let valor = punto.currentTarget.getAttribute("cal")
